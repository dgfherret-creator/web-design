...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  fragColor = rays1 * 0.48 + rays2 * 0.36;
  ...
  fragColor.z *= 0.1 + brightness * 0.22;
  ...
  fragColor.a = clamp(max(max(fragColor.r, fragColor.g), fragColor.b), 0.0, 0.72);
}
  ...
  gl_FragColor = color;
      ...
      cleanupFunctionRef.current = () => {
        ...
        try {
          ...
          // Canvas cleanup can fail if the browser has already released the context.
        }
